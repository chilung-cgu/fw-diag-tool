...
class CHeaderGenerator:
    ...
    @classmethod
    def header_filename(cls, module_name: str = "CHIP_REGS") -> str:
        module_identifier = cls._require_identifier("module_name", module_name)
        return f"{module_identifier.lower()}.h"
    ...
    def generate_header(self, module_name: str = "CHIP_REGS") -> str:
        ...
        header_filename = self.header_filename(module_name)
